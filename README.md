...
- 포인트 색 : #A785EF
- 기본 폰트색 : #fff
- 벤치마킹 : 키노라이츠(https://m.kinolights.com)
- 개발환경 : Html, Jsp, Css, JavaScript, jQuery, Apache Tomcat, Spring, MySQL, aJax, Python, MyBatis, Visual Studio Code, IntelliJ, Notion, MySQL Workbench
